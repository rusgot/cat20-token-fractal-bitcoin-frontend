...
[https://github.com/rusgot/cat20-token-fractal-bitcoin](https://github.com/rusgot/cat20-token-fractal-bitcoin)
...
```bash
git clone https://github.com/rusgot/cat20-token-fractal-bitcoin.git
cd cat-token-box
```
